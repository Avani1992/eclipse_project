/* Goto the website and get the link of all socialmedia icon present in the website.
 * eg. when we click on the facebook icon it redirect to the facebookpage of that website. 
 * Get that URL. so we can directly go that facebook page of that website  without going to that website.
 * */
